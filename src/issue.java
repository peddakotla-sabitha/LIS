    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         ResultSet s = null;
          try {
            ...
            String query="select * from approved_requests";
...
"");
            ...
            //out.println("<h1>Servlet signup at " + request.getContextPath() + "</h1>");
             out.println("<center><h3 class='mt-3' style='text-decoration: underline;'>Approved users</h3></center>");
            out.println(" <table class='tables mt-3' border='4' align='center' cellpadding='5' width='800'>");
            ...
            out.println("<th scope='col'width='160'>Library_id</th>");
            ...
            out.println("<td scope='col'width='250'>"+ s.getString("BookName")+"</td>");
            out.println("<td scope='col'width='160'>"+s.getString("ISBN")+"</td>");
             out.println("<td scope='col' width='50'>" +s.getString("Library_id")+ "</td>");  
              out.println("<td scope='col'><form>"
                                        + "<button class='btn btn-outline-success btn-sm  me-2'><a href='issue.html' class='text-dark' style='text-decoration: none;'>Issue book</a></button>"

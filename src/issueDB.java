 ...
 * @author student
 */
public class issueDB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int status = 0;
          ...
          try {
            ...
            String query="insert into issued_books values('"+lid+"','"+bname+"','"+isbn+"','"+date+"','"+ddate+"')";
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            */
             out.println("<h5 style='color: green'><script  type='text/javascript'>window.location.href='issue.html';\n" +

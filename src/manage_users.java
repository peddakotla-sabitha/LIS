    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         ResultSet s = null;
          try {
            ...
            Logger.getLogger(manage_users.class.getName()).log(Level.SEVERE, null, ex);
        }
...
"");
            ...
            out.println("<tr>");               
             out.println("<th scope='col'width='50'>Lib_id</th>");               
            ...
            out.println("<th scope='col' width='50'>Mobile Number</th>");
             out.println("<th scope='col'width='50'>Address</th>");
              out.println("<th scope='col' width='100'>Operations</th>");
            out.println("</tr>");
            out.println("</thead>");
            ...
            try {
                while(s.next()){
             out.println("<tr>");  
             out.println("<td scope='col' width='100'>" +s.getString("Library_id")+ "</td>"); 
            ...
            out.println("<td scope='col' width='50'>"+s.getString("MobileNumber")+"</td>");
             out.println("<td scope='col'width='50'>"+s.getString("Address")+"</td>");
              out.println("<td scope='col' width='100'><form>"
                                        + "<button class='btn btn-outline-success btn-sm mb-2'><a href='user_update.jsp?email="+s.getString("email")+"' class='text-dark' style='text-decoration: none;'>Update</a></button>"
                                        + "<button class='btn btn-outline-danger btn-sm'><a href='user_delete?id="+s.getString("Library_id")+"' class='text-dark' style='text-decoration: none;'>Delete</a></button>"
                                        + "</form>  "
                                        + "</td>");

...
"");
            ...
            out.println("<th scope='col' width='50'>RackNumber</th>");
             out.println("<th scope='col'width='50'>Copies</th>");
              out.println("<th scope='col'>Operations</th>");
            out.println("</tr>");
            out.println("</thead>");
            ...
            try {
                while(s.next()){
             out.println("<tr>");               
            out.println("<td scope='col' width='50'>" +s.getString("BookName")+ "</td>");                
            out.println("<td scope='col'width='250'>"+ s.getString("ISBN")+"</td>");
            out.println("<td scope='col'width='160'>"+s.getString("AuthorName")+"</td>");
            out.println("<td scope='col'width='120'>"+s.getString("Branch")+"</td>");
            out.println("<td scope='col' width='150'>"+s.getString("RackNumber")+"</td>");
             out.println("<td scope='col'width='80'>"+s.getString("Copies")+"</td>");
              out.println("<td scope='col'><form>"
                                        + "<button class='btn btn-outline-success btn-sm  me-2'><a href='update.jsp?id="+s.getString("ISBN")+"' class='text-dark' style='text-decoration: none;'>Update</a></button>"
                                        + "<button class='btn btn-outline-danger btn-sm '><a href='delete?id="+s.getString("ISBN")+"' class='text-dark' style='text-decoration: none;'>Delete</a></button>"
                                        + "</form>  "
                                        + "</td>");

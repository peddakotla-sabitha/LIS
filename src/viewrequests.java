    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         ResultSet s = null;
          try {
            ...
            String query="select * from request_book";
...
"");
            ...
            //out.println("<h1>Servlet signup at " + request.getContextPath() + "</h1>");
             out.println("<center><h3 class='mt-3' style='text-decoration: underline;'>Request Book Details</h3></center>");
            ...
            out.println("<td scope='col'width='160'>"+s.getString("ISBN")+"</td>");
             out.println("<td scope='col' width='50'>" +s.getString("Library_id")+ "</td>");  
              out.println("<td scope='col'><form>"
                                        + "<button class='btn btn-outline-success btn-sm  me-2'><a href='approveDB?id="+s.getString("Library_id")+"&name="+s.getString("BookName")+"&isbn="+s.getString("ISBN")+"' class='text-dark' style='text-decoration: none;'>Approve</a></button>"

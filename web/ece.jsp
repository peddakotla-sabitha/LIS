<%-- 
    Document   : ece
    Created on : 22-Dec-2023, 10:06:47 pm
    Author     : student
--%>
...
<html>
    <%
        ...
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/lis","root","Sabi@319");
         ...
         ResultSet result=st.executeQuery("select * from books_info where Branch='ECE'");
         %>
         <div class="topright">
                ...
                <div class="third">
                    <div class="card width-20 ">
                        <div class="card-img-top d-flex align-items-center" style="background-color:white;">
                         <div>
                         <img class="img-fluid" src="vani_img/ee1.jpeg" alt="Card image cap">
                        </div>
    ...
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <title>Electronics Communication</title>
        <meta charset="UTF-8">

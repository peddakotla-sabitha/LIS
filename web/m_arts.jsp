<%-- 
    Document   : m_arts
    Created on : 22-Dec-2023, 9:54:29 pm
    Author     : student
--%>
...
<html>
    <%
        ...
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/lis","root","Sabi@319");
         ...
         ResultSet result=st.executeQuery("select * from books_info where Branch='MA'");
         %>
         <div class="topright">
                ...
                <div class="third">
                    <div class="card width-20 ">
                        <div class="card-img-top d-flex align-items-center" style="background-color:white;">
                         <div>
                         <img class="img-fluid" src="vani_img/ma1.jpeg" alt="Card image cap">
                        </div>

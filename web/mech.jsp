<%-- 
    Document   : mech
    Created on : 22-Dec-2023, 10:03:27 pm
    Author     : student
--%>
...
<html>
    <%
        ...
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/lis","root","Sabi@319");
         ...
         ResultSet result=st.executeQuery("select * from books_info where Branch='MECH'");
         %>
         <div class="topright">
                ...
                <div class="third">
                    <div class="card width-20 ">
                        <div class="card-img-top d-flex align-items-center" style="background-color:white;">
                         <div>
                         <img class="img-fluid" src="vani_img/me10.jpeg" alt="Card image cap">
                        </div>

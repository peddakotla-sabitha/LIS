<%-- 
    Document   : psychology
    Created on : 22-Dec-2023, 10:04:24 pm
    Author     : student
--%>
...
<html>
    <%
        ...
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/lis","root","Sabi@319");
         ...
         ResultSet result=st.executeQuery("select * from books_info where Branch='PSYCHOLOGY'");
         %>
         <div class="topright">
                ...
                <div class="third">
                    <div class="card width-20 ">
                        <div class="card-img-top d-flex align-items-center" style="background-color:white;">
                         <div>
                         <img class="img-fluid" src="vani_img/phy2.jpg" alt="Card image cap">
                        </div>
